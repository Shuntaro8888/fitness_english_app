...
final List<Workout> dummyWorkouts = [
  Workout(
    ...
    phrases: [
      AudioPhrase(
        audioPathEn: 'assets/audio/workouts/push_up/001_e.mp3',
        audioPathJp: 'assets/audio/workouts/push_up/001_j.mp3',
  ...
  Workout(
    ...
    phrases: [
      AudioPhrase(
        audioPathEn: 'assets/audio/workouts/squat/001_e.mp3',
        audioPathJp: 'assets/audio/workouts/squat/001_j.mp3',
...
final List<Quote> dummyQuotes = [
  Quote(
    ...
    audioPath: 'assets/audio/quotes/q001_e.mp3',
  ),
  Quote(
    id: 'q2',
    englishText: 'Strive for progress, not perfection.',
    japaneseText: '完璧ではなく、進歩を目指せ。',
    audioPath: 'assets/audio/quotes/q002_e.mp3',
  ),
];